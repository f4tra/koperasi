...
class Itemlist extends Admin_Controller 
{
	...
	function load(){
		$edit	= site_url('inventory/itemlist/form/$1');		
		$chart	= site_url('inventory/itemlist/chart/$1');		
		$file	= site_url('inventory/cloud/index/$1');		
					/*<a title="Edit"class="btn btn-purple btn-m" href="'.$file.'"><i class="fa fa-doc"></i></a>*/
		$link	= '	
		...
		if($method == "update")
		{
			...
			if($ctg != null){
				...
				$data =  array(
					...
					"x_id"	=> $this->input->post('wing'),
					"y_id"	=> $this->input->post('floor'),
					"z_id"	=> $this->input->post('tower'),
