	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="box border green">
				<div class="box-title">
					<h4><i class="fa fa-table"></i>Component List<?php //echo $this->uri->segment(2); ?></h4> 					
				</div>
				<div class="box-body">
				...
				<tbody>
					...
					<a class="btn btn-warning" href="<?php echo site_url('object/component/form');?>">Add New</a>
				</div>
...
$(document).ready(function() {
	$('#data').dataTable({
		...
		"bProcessing": true,
		"bServerSide": true,
		"sAjaxSource": "<?php echo site_url('object/component/load');?>",
		"sServerMethod": "POST",
		"aaSorting": [[0, "asc"]],
		"iDisplayLength": 10,			
		"aoColumns" : [		
			...
			{"mData": "category",
				"mRender" : function ( data, type, par ) {				
					if(par.category == null || par.category == '0' || par.category == 0){
	...
	$('#data').delegate('.checkbox','change',function() {
		...
		if(this.checked){
			//alert("checked");
			$.ajax({
				url: "<?php echo site_url('object/component/execute/active/'); ?>",
				type: 'post',
