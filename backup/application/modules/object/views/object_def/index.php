		...
		<div class="col-md-12">
			...
			<div class="box border green">
				...
				<tbody>
					...
					<a class="btn btn-warning" href="<?php echo site_url('object/object_def/form/'.$f);?>">Add New</a>
				</div>
...
$(document).ready(function() {
	$('#data').dataTable({
		...
		"bProcessing": true,
		"bServerSide": true,
		"sAjaxSource": "<?php echo site_url('object/object_def/load/'.$f);?>",
		"sServerMethod": "POST",
		"aaSorting": [[0, "asc"]],
		"iDisplayLength": 10,			
		"aoColumns" : [		
			...
			{"mData": "object",
				"mRender" : function ( data, type, par ) {				
					if(par.object == null || par.object == '0' || par.object == 0){
	...
	$('#data').delegate('.checkbox','change',function() {
		...
		if(this.checked){
			//alert("checked");
			$.ajax({
				url: "<?php echo site_url('object/object_def/execute/active/'); ?>",
				type: 'post',
...
function del(btn)
{
	...
	else
	{
		...
		$.ajax({
			url: "<?php echo site_url('object/object_def/execute/');?>",
			type: "POST",
