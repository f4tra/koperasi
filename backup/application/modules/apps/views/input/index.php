		...
		<div class="col-md-12">
			...
			<div class="box border green">
				...
				<tbody>
					...
					<a class="btn btn-warning" href="<?php echo site_url('apps/input/index/add/').'/'.$ipo_id.'/'.$type_id;?>">Add New</a>
				</div>
...
$(document).ready(function() {
	$('#data').dataTable({
		...
		"bProcessing": true,
		"bServerSide": true,
		"sAjaxSource": "<?php echo site_url('apps/ajax/load/').'/'.$ipo_id.'/'.$type_id;?>",
		"sServerMethod": "POST",
		"aaSorting": [[0, "asc"]],
		"iDisplayLength": 10,			
		"aoColumns" : [		
...
function del(btn)
{
	...
	else
	{
		...
		$.ajax({
			url: '<?php echo site_url().'apps/ajax/index/delete/';?>',
			type: "POST",
			data:{data_id:id},
			crossDomain:true,
			beforeSend: function(){
