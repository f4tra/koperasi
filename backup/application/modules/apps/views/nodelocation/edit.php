	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="box border orange">
				<div class="box-title">
					<h4><i class="fa fa-preorder"></i> </h4> 
					...
					<form class="form-horizontal row-border"  method="post" id="form">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								...
								?>
									<option  <?php echo $a;?> value="<?php echo $g->id;?>"><?php echo $g->code." ".$g->username;?></option>
									<?php } ?>
								</select>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-4">
								<input type="text" value="<?php echo $edit->gps_x;?>" name="gpsx" id="gpsx" class="form-control" /><br/>
								<input type="text" value="<?php echo $edit->gps_y;?>" name="gpsy" id="gpsy" class="form-control" />
							</div>
						</div>
						<div class="form-group">
...
function save(){
	$('#form').validate({
		...
		submitHandler: function(form){
			$.ajax({
				url: '<?php echo base_url();?>index.php/apps/nodelocation/execute/update/<?php echo $edit->id;?>',
				type: "POST",
				dataType:"json",
				data: $("#form").serialize(),
				beforeSend: function(){
