...
class Employess extends Admin_Controller 
{
	...
	function load(){
		$edit	= site_url('apps/employess/form/$1');		
	...
	function load_education_type($id =''){
		$edit	= site_url('apps/employess/form_education/'.$id.'/$1');		
	...
	function load_job_history($id){
		$edit	= site_url('apps/employess/form_job/'.$id.'/$1');		
		$link	= '	<a title="Edit" class="btn btn-warning btn-m" href="'.$edit.'"><i class="fa fa-pencil"></i></a> 
	...
	{		
		...
		$education_type		= json_decode(file_get_contents(base_url()."data/json_data.php?type=education_type"));
		$this->data['tr_hr_religion']		= $uri_religion;
			...
			$this->data['tr_hr_div']			= $this->mgeneral->Getwhere(array('or_type_id'=>1),"tr_hr_org");
			$this->data['tr_hr_grp']			= $this->mgeneral->GetAll("tr_hr_grp");
			$this->data['tr_hr_stc']			= $this->mgeneral->Getwhere(array('or_type_id'=>2),"tr_hr_org");
			$this->data['tr_hr_fnc']			= $this->mgeneral->Getwhere(array('or_type_id'=>3),"tr_hr_org");
			$this->data['TR_HR_EDUCATION_TYPE']	= $education_type;
		if(!isset($id)){
			
			//$this->data['USERINFO']				= $this->mgeneral->GetAll("USERINFO");
			...
			$this->data['TR_SYS_AREA_PROVINCE']	= $province;
			$this->data['TR_SYS_AREA_DISTRICT']	= $district;
			$this->data['tr_hr_div']			= $this->mgeneral->GetAll("tr_hr_div");
			$this->data['tr_hr_fnc']			= $this->mgeneral->GetAll("tr_hr_fnc");
			$this->data['tr_hr_grp']			= $this->mgeneral->GetAll("tr_hr_grp");
			$this->data['tr_hr_stc']			= $this->mgeneral->GetAll("tr_hr_stc");
			$this->data['TR_HR_EDUCATION_TYPE']	= $education_type;*/
			//$this->data['USERINFO']		= $this->mgeneral->GetAll("USERINFO");
