	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="box border green">
				<div class="box-title">
					<h4><i class="fa fa-table"></i>Role </h4> 
				...
				<div class="box-body">
					...
					<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="data" width="100%">
					<thead>
						<tr>
							<th>ID</th>
							<th>Code</th>
					...
					<a  class="btn btn-warning" href="<?php echo site_url('setup/role/add');?>">Add New</a>
				</div>
			</div>
			<!-- /BOX -->
		</div>
...
$(document).ready(function(){
	$('#data').dataTable({
		...
		"bProcessing": true,
		"bServerSide": true,
		"sAjaxSource": "<?php echo site_url('setup/role/load');?>",
		"sServerMethod": "POST",
...
function del(btn)
{
	...
	else
	{
		...
		$.ajax({
			url: '<?=base_url().'index.php/setup/role/execute/delete/';?>'+id,
			type: "POST",
			data:{data_id:id},
			crossDomain:true,
			beforeSend: function(){
