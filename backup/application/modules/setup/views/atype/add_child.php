				...
				<div class="box-body">
					...
					<form class="form-horizontal row-border"  method="post" id="form">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input type="text" value="0" name="left" id="left" class="form-control" placeholder="Left" />
							</div>
						</div>
						<div class="form-group">
							<label class="col-md-2 control-label">P_Top:</label> 
							<div class="col-md-4">
								<input type="text" value="0" name="top" id="top" class="form-control" placeholder="TOP" />
							</div>
						</div>
						<div class="form-group">
							<label class="col-md-2 control-label">P_Width:</label> 
							<div class="col-md-4">
								<input type="text" value="10"  name="width" id="width" class="form-control" placeholder="Width" />
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-4">							
								...
								<input type="hidden" value="<?php echo $type->id;?>" name="type_id" id="type_id">
						...
						<div class="form-group">
							...
							<div class="col-md-4">							
								...
								<select  name="parent_id" id="parent_id" class="select2-01 col-md-12 full-width-fix">
									<?php
										if($type->parent_id == 0){
											echo '<option value="0">Unidentify</option>';
										}else{
									?>
									<?php
...
function save(){
	$('#form').validate({
		...
		submitHandler: function(form){
			$.ajax({
				url: '<?php echo base_url();?>index.php/setup/atype/execute_child/save',
				type: "POST",
				dataType:"json",
				data: $("#form").serialize(),
				beforeSend: function(){
