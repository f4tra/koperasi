	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="box border orange">
				<div class="box-title">
					<h4><i class="fa fa-table"></i>Work Group </h4> 
				...
				<div class="box-body">
					...
					<form class="form-horizontal row-border"  method="post" id="form">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<select class="select2-01 col-md-12 full-width-fix" name="parent_id" id="parent_id">
								<option value="0">Unidentify</option>
								<?php foreach($workgroup as $g){
...
function save(){
	$('#form').validate({
		...
		submitHandler: function(form){
			$.ajax({
				url: '<?php echo base_url();?>index.php/setup/workgroup/execute/update/<?php echo $edit->id;?>',
				type: "POST",
				dataType:"json",
				data: $("#form").serialize(),
				beforeSend: function(){
