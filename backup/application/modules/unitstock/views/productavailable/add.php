				...
				<div class="box-body">
					...
					<form class="form-horizontal row-border"  method="post" id="form">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<select name="seller_id" id="seller_id" class="select2-01 col-md-12 full-width-fix">
								<option value="0">Unidentify</option>
								<?php 
								foreach($user as $i){
									
								?>
									<option   value="<?php echo $i->id;?>"><?php echo $i->code." ".$i->nick_name;?></option>
									<?php } ?>
								</select>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<select name="owner_id" id="owner_id" class="select2-01 col-md-12 full-width-fix">
								<option value="0">Unidentify</option>
								<?php 
								foreach($user as $i){
						...
						<div class="form-group">
                            ...
                            <div class="input-group">
                            	<input type="text" name="start_date" id="start_date" class="form-control" data-mask="99/99/9999"><span class="input-group-btn"> <button class="btn btn-primary" id="start_date_btn" type="button"><i class="fa fa-calendar" ></i> Date</button> </span>
                            </div>                                                                                                                   
                       </div>
                            ...
                            <div class="form-group">
                                <label class="col-md-2 control-label">End Date</label>
                               	<div class="col-md-3">
                                            <div class="input-group">
                                                <input type="text" name="end_date" id="end_date"  class="form-control" data-mask="99/99/9999"><span class="input-group-btn"> <button class="btn btn-primary" id="end_date_btn" type="button"><i class="fa fa-calendar" ></i> Date</button> </span>
                                            </div>                                                                                                                   
                                        </div>
...
function save(){
	$('#form').validate({
		...
		submitHandler: function(form){
			$.ajax({
				url: '<?php echo base_url();?>index.php/unitstock/productavailable/execute/save',
				type: "POST",
				dataType:"json",
				data: $("#form").serialize(),
				beforeSend: function(){
