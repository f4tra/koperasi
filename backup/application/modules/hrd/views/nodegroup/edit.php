	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="box border orange">
				<div class="box-title">
					<h4><i class="fa fa-table"></i>Node Group </h4> 
				...
				<div class="box-body">
					...
					<form class="form-horizontal row-border"  method="post" id="form">
						...
						<!-- <div class="form-group">
							...
							<div class="col-md-4">							
								<select  name="issuer_id" id="issuer_id" class="select2-01 col-md-12 full-width-fix">
									<option value="0">Unidentify</option>
									<?php 
										foreach($issuer as $key => $value) {
											...
											print '<option '.$a.' value="'.$value->id.'">'.$value->name.'</option>';
										}
									?>									
								</select>
							</div>
...
function save(){
	$('#form').validate({
		...
		submitHandler: function(form){
			$.ajax({
				url: '<?php echo base_url();?>index.php/organization/nodegroup/execute/update/<?php echo $edit->id;?>',
				type: "POST",
				dataType:"json",
				data: $("#form").serialize(),
				beforeSend: function(){
