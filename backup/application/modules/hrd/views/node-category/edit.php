...
function save(){
	$('#form').validate({
		...
		submitHandler: function(form){
			$.ajax({
				url: '<?php echo base_url();?>index.php/organization/nodecategory/execute/update/<?php echo $edit->id;?>',
				type: "POST",
				dataType:"json",
				data: $("#form").serialize(),
				beforeSend: function(){
				...
				success:function(data){
					...
					$.pnotify({
								title: 'Node Category Edited',
								text: 'Node Category Edited',
								animation: {
									effect_in: 'show',
									effect_out: 'slide'
								},
