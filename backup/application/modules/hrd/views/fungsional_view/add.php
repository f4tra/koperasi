	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="box border orange">
				<div class="box-title">
					<h4><i class="fa fa-table"></i>Functional Level</h4> 					
				</div>
				<div class="box-body">
					<!-- Form-->
						...
						<div class="form-group">
							...
							<div class="col-md-4">							
								<select  name="stc_id" id="stc_id" class="select2-01 col-md-12 full-width-fix">
									...
									<?php 
										foreach($stc as $key => $values) {
											print '<option value="'.$values->id.'">'.$values->code." ".$values->name.'</option>';
										}
									?>									
								</select>
							</div>
...
function save(){
	$('#form').validate({
		...
		submitHandler: function(form){
			$.ajax({
				url: '<?php echo base_url();?>index.php/hrd/fungsional/execute/save',
				type: "POST",
				dataType:"json",
				data: $("#form").serialize(),
				beforeSend: function(){
