	...
	<div id="content" class="col-lg-12">
		...
		<div class="row">
			<div class="col-sm-12">
				...
				<!-- /BREADCRUMBS -->
				<div class="clearfix">
					<h3 class="content-title pull-left">Rule</h3>
				</div>
	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="box border yellow">
				<div class="box-title">
					<h4><i class="fa fa-table"></i>Form Rule Edit </h4> 
					...
					<form class="form-horizontal row-border"  method="post" id="form">
						...
						<div class="form-group">
							...
							<div class="col-md-3">
								...
								?>
									<option <?php echo $mm;?> value="<?=$r->id;?>"><?=$r->name;?></option>
									<?php } ?>
								</select>
							</div>
						</div>
						<div class="form-group">
							<label class="col-md-1 control-label">GUI:</label> 
							<div class="col-md-3">
								...
								?>
									<option <?php echo $m;?> value="<?=$g->id;?>"><?=$g->name;?></option>
									<?php } ?>
								</select>
							</div>
						</div>
