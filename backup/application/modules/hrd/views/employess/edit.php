                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="box_tab6">
                            ...
                            <div class="form-group">
                                ...
                                <a class="btn btn-warning" href="<?php echo site_url('organization/employess/form_education/').'/'.$edit->id;?>">Add New</a>
                        ...
                        <div class="tab-pane" id="box_tab7">
                            ...
                            <div class="form-group">
                                ...
                                <a class="btn btn-warning" href="<?php echo site_url('organization/employess/form_job/').'/'.$edit->id;?>">Add New</a>
                        ...
                        <div class="tab-pane" id="box_tab8">
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <select  size="1" name="role"  id="role" class="select2-01 col-md-8">
                                        <option value="0"></option>
                                        <?php 
                                            foreach ($role as $key => $value) {
                                                if($value->id == $edit->role_id){
                                                    $a='selected';
                                                }else{
                                                    $a= '';
                                                }
...
$(document).ready(function() {
    $('#data').dataTable({
        ...
        "bProcessing": true,
        "bServerSide": true,
        "sAjaxSource": "<?php echo site_url('hrd/employess/load_education_type').'/'.$edit->id;?>",
        "sServerMethod": "POST",        
        "aaSorting": [[0, "asc"]],
        "iDisplayLength": 10,           
        "aoColumns" : [            
    ...
    $('#experiance').dataTable({
        ...
        "bProcessing": true,
        "bServerSide": true,
        "sAjaxSource": "<?php echo site_url('hrd/employess/load_job_history').'/'.$edit->id;?>",
        "sServerMethod": "POST",        
        "aaSorting": [[0, "asc"]],
        "iDisplayLength": 10,           
        "aoColumns" : [            
...
function save(){
	$('#form').validate({
		...
		submitHandler: function(form){
			...
			$.ajax({
				url: '<?php echo base_url();?>index.php/hrd/employess/execute/update/<?php echo $edit->id;?>',
				type: "POST",
				dataType: 'json',
                cache: false,
                contentType: false,
...
function del_edu(btn)
{
    ...
    else
    {
        ...
        $.ajax({
            url: '<?php echo base_url().'index.php/hrd/employess/execute_hr_edu/delete/';?>'+id,
            type: "POST",
            data:{data_id:id},
            crossDomain:true,
            beforeSend: function(){
...
function del_job(btn)
{
    ...
    else
    {
        var id = $(btn).attr('data-id');        
        $.ajax({
            url: '<?php echo base_url().'index.php/hrd/employess/execute_hr_job/delete/';?>'+id,
            type: "POST",
            data:{data_id:id},
            crossDomain:true,
            beforeSend: function(){
