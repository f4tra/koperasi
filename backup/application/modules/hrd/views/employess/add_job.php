				...
				<div class="box-body">
					...
					<form class="form-horizontal row-border"  method="post" id="form">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<textarea cols="30" rows="10" name="achievement" id="achievement" class="form-control" placeholder="ACHIEVEMENT" ></textarea>
							</div>
						</div>
						<div class="form-group">
							<label class="col-md-2 control-label">PERFORMANCE:</label> 
							<div class="col-md-4">
								<textarea cols="30" rows="10" name="PERFORMANCE" id="PERFORMANCE" class="form-control" placeholder="PERFORMANCE" ></textarea>
							</div>
						</div>
						<div class="form-group">
							<label class="col-md-2 control-label">TECHNOLOGY:</label> 
							<div class="col-md-4">
								<textarea cols="30" rows="10"  name="TECHNOLOGY" id="TECHNOLOGY" class="form-control" placeholder="TECHNOLOGY" ></textarea>
							</div>
						</div>
						<div class="form-group">
...
function save(){
	$('#form').validate({
		...
		submitHandler: function(form){
			$.ajax({
				url: '<?php echo base_url();?>index.php/organization/employess/execute_hr_job/save',
				type: "POST",
				dataType:"json",
				data: $("#form").serialize(),
				beforeSend: function(){
