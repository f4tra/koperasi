				...
				<div class="box-body">
					...
					<form class="form-horizontal row-border"  method="post" id="form">
						...
						<!-- <div class="form-group">
							...
							<div class="col-md-4">
								<select name="grp_id" id="grp_id" class="select2-01 col-md-12 full-width-fix">
								<option selected value="0">Unidentify</option>
								<?php foreach($node_grp as $g){ ?>
...
function save(){
	$('#form').validate({
		...
		submitHandler: function(form){
			$.ajax({
				url: "<?php echo site_url('organization/nodetype/execute/save');?>",
				type: "POST",
				dataType:"json",
				data: $("#form").serialize(),
				beforeSend: function(){
