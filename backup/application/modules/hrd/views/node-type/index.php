	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="box border green">
				<div class="box-title">
					<h4><i class="fa fa-table"></i>Node Type</h4> 					
				</div>
				<div class="box-body">
				...
				<tbody>
					...
					<a class="btn btn-warning" href="<?php echo site_url('organization/nodetype/form');?>">Add New</a>
				</div>
...
$(document).ready(function() {
	$('#data').dataTable({
		...
		"bProcessing": true,
		"bServerSide": true,
		"sAjaxSource": "<?php echo site_url('organization/nodetype/load');?>",
		"sServerMethod": "POST",
		"aaSorting": [[1, "asc"]],
		"iDisplayLength": 10,			
		"aoColumns" : [		
	...
	$('#data').delegate('.checkbox','change',function() {
		...
		if(this.checked){
			//alert("checked");
			$.ajax({
				url: "<?php echo site_url('organization/nodetype/execute/active/'); ?>",
				type: 'post',
				data: 'active=1&id='+i,
...
function del(btn)
{
	...
	else
	{
		...
		$.ajax({
			url: "<?php echo site_url('organization/nodetype/execute/delete/');?>/"+id,
			type: "POST",
			data:{data_id:id},
			crossDomain:true,
			beforeSend: function(){
