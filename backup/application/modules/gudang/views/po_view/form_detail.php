						...
						<table class="table">
							...
							<?php $no=1;foreach ($purchasing_detail as $key => $value) { ?>
								<tr>
									...
									<td>
										<div class="col-md-8">
										<select name="gudang_<?php echo $no;?>" id="gudang_<?php echo $no;?>" class="form-control">
										<?php
										foreach ($gudang as $key => $valuem) {
											echo "<option value='".$valuem->id."'>".$valuem->name."</option>";
											# code...
										}
									...
									<select name="rak_<?php echo $no;?>" id="rak_<?php echo $no;?>" class="form-control">
										<?php

										foreach ($rak as $key => $values) {
								...
								<input type="hidden" name="jum" id="jum" value="<?php echo count($purchasing_detail); ?>">
								<input type="hidden" name="item_id_<?php echo $no;?>" id="item_id_<?php echo $no;?>" value="<?php echo $value->item_id; ?>">
								<input type="hidden" name="qty_<?php echo $no;?>" id="qty_<?php echo $no;?>" value="<?php echo $value->qty; ?>">
							<?php $no++;}	?>
