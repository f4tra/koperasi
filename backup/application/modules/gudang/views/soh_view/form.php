	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="box border orange">
				<div class="box-title">
					<h4><i class="fa fa-table"></i>Labeling<?php //echo $this->uri->segment(2); ?></h4> 					
				</div>
				<div class="box-body">
					<!-- Form-->
					<form class="form-horizontal row-border"  method="post" id="form">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input type="text" value="<?php echo $item->name;?>" name="name" id="name" class="form-control" placeholder="Name" />
							</div>
						</div> 
						<!-- <div class="form-group">
...
function save(){
	$('#form').validate({
		...
		submitHandler: function(form){
			$.ajax({
				url: "<?php echo site_url('gudang/soh/execute/'.$edit->id);?>",
				type: "POST",
				dataType:"json",
				data: $("#form").serialize(),
				beforeSend: function(){
