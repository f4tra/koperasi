	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="box border green">
				...
				<div class="box-body">
					<form enctype="multipart/form-data" action="<?php echo site_url('inventory/cloud/upload/'.$item_id)?>" class="dropzone" id="drop" method="POST"/>
						<div class="fallback">
...
function upload(){
	try {
        $("#drop").dropzone({
        	init: function() {
       			thisDropzone = this;
        		$.get("<?php echo site_url('inventory/cloud/view')?>", function(data) {
 					$.each(data, function(key,value){
                		var mockFile = { name: value.name, size: value.size };
                		thisDropzone.options.addedfile.call(thisDropzone, mockFile); 
                		thisDropzone.options.thumbnail.call(thisDropzone, mockFile, "uploader/product/"+value.name);
            		});
             	});
    		},
            paramName: "userfile",
            ...
            removedfile: function(file) {
            	...
            	alert(name)
 				$.ajax({
        			type: 'POST',
        			url: "<?php echo site_url('inventory/cloud/remove')?>",
        			data: "data_id="+name,
    			});
				var _ref;
