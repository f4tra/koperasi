				...
				<div class="box-body">
					...
					<form enctype="multipart/form-data" class="form-horizontal row-border"  method="post" id="form">
						...
						<div class="form-group">
							...
							<div class="col-md-2">
								<input type="text" name="feeprc" id="feeprc" class="form-control" placeholder="Transaction Fee" />
							</div>
						</div>
						<div class="form-group">
...
function save(){
	$('#form').validate({
		...
		submitHandler: function(form){
			...
			$.ajax({
				url: '<?php echo base_url();?>index.php/inventory/productcategory/execute/save',
				type: "POST",
				dataType:"json",
				cache: false,
                contentType: false,
