	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="box border orange">
				<div class="box-title">
					<h4><i class="fa fa-reorder"></i> Pengajuan Pengadaan | <?php echo $purchasing->code;?></h4> 					
				</div>
				<div class="box-body">
					<!-- Form-->
							...
							<div class="form-group">
	                            ...
	                            <div class="col-md-3">
	                            	<div class="input-group">
	                                	...
	                                	<input type="text" value=" <?php echo $purchasing->tgl_pembayaran;?>"name="start_date" id="start_date" class="form-control" data-mask="99/99/9999"><span class="input-group-btn"> <button class="btn btn-primary" id="btndp" type="button"><i class="fa fa-calendar" ></i> Date</button> </span>
	                                </div>                                                                                                                   
	                            </div>
							</div>
						<table class="table">
							...
							<?php $no++;}	?>
							<tr>									
									<td colspan="7" scope="row"><center><h4><b>Total Rp.<?php echo number_format($purchasing_detail_jum->total,2); ?></b></h4></center></td>
								</tr>
	...
	$('#form').validate({
		...
		submitHandler: function(form){
			$.ajax({
				...
				url: "<?php echo site_url();?>purchasing/pembayaran/execute/update/<?php echo $purchasing->id;?>",
				type: "POST",
				dataType:"json",
				data: $("#form").serialize(),
				beforeSend: function(){
