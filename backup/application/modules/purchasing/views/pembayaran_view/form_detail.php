...
function grap(){
	var id = $("#item").val();
	$.ajax({
		url: "<?php echo site_url();?>purchasing/pembayaran/grap/",
		type: "POST",
		dataType:"html",
		data: "id="+id,
...
function hapus(){
	...
	var data =  "id="+idx;
	$.ajax({
		url: "<?php echo site_url();?>purchasing/pembayaran/execute/delete_detail/",
		type: "POST",
		dataType:"json",
		data: data,
		success:function(data){
...
function update(){
	...
	$.ajax({
		url: "<?php echo site_url();?>purchasing/pembayaran/execute/update_detail/",
		type: "POST",
		dataType:"json",
		data: data,
		success:function(data){
	...
	$('#form').validate({
		...
		submitHandler: function(form){
			$.ajax({
				...
				url: "<?php echo site_url();?>purchasing/pembayaran/execute/save_detail/",
				type: "POST",
				dataType:"json",
				data: $("#form").serialize(),
				beforeSend: function(){
