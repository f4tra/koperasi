			...
			<div class="box border orange">
				...
				<div class="box-body">
					...
					<form class="form-horizontal row-border"  method="post" id="form">
						...
						<div class="form-group">
							<label class="col-md-2 control-label">Pengadaan :</label> 
							<div class="col-md-4">
								<select  size="1" name="parent_id"  id="parent_id" class="select2-01 col-md-12">
									<option  value="0">-= UNIDENTIFY =-</option>
						 			<?php
						 				foreach ($pengadaan as $key => $values) {
	...
	$('#form').validate({
		...
		submitHandler: function(form){
			$.ajax({
				...
				url: "<?php echo site_url();?>purchasing/po/execute/save/",
				type: "POST",
				dataType:"json",
				data: $("#form").serialize(),
				beforeSend: function(){
