	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="box border green">
				...
				<div class="box-body">
					<form enctype="multipart/form-data" action="<?php echo site_url('cloud/cloud/upload')?>" class="dropzone" id="drop" method="POST"/>
						<div class="fallback">
...
function upload(){
	try {
        $("#drop").dropzone({
        	init: function() {
       			thisDropzone = this;
        		$.get("<?php echo site_url('cloud/cloud/view')?>", function(data) {
            ...
            removedfile: function(file) {
            	...
            	alert(name)
 				$.ajax({
        			type: 'POST',
        			url: "<?php echo site_url('cloud/cloud/remove')?>",
        			data: "data_id="+name,
    			});
				var _ref;
