				...
				<div class="box-body" id="dropzone" >
		            ...
		            ?>
		                ...
		                <img  width="30px"  src="<?php echo base_url('assets/wf/'.$value->icons.''); ?>" />
		               	<br/>
		               		<a href="<?php echo site_url('workflow/group/detail/'.$value->group_id); ?>
	...
	var instance = jsPlumb.getInstance({
		...
		?>
			/*instance.connect({
				...
				overlays : [
					["Label", {													   					
						label : "<a data-descr_con='<?php //echo $value->descr;?>' data-name_con='<?php //echo $value->name;?>' data-code_con='<?php //echo $value->code;?>' href='#box-connect' data-toggle='modal' class='btn btn-primary' id='box_connects'><i class='fa fa-pencil'></i> Details</a>",
						location: 0.7,
					}],
				],
