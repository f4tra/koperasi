...
/*
	...
	Generate Authkey and Signature for BCA KlikPay Version 1.2
...
v1.2	12 Nov 2012
- Minimum length of transactionNo now is 1 (since it will be padded anyways)
v1.3	15 Jan 2013
...
class enkripsi_klikpay 
{
	...
	private function tripledes($str,$key) {
		...
		try {
			...
			mcrypt_generic_init($mmod,implode("",$bk), str_pad("",8,"\0",STR_PAD_LEFT));
