		...
		<div class="container">
				...
				<ul class="nav navbar-nav pull-right">
					...
					$sqlmenu1	=$this->db->query("
						...
						INNER JOIN tr_role_gui AS b ON a.id = b.gui_id where a.parent_id='0' and b.active='1' and b.role_id='".$session->role_id."' ORDER BY a.code ASC")->result();
					if($sqlmenu1->role_id == 1){
					...
					<li class="dropdown" id="header-tasks">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
							<i class="fa <?php echo $menu1->icons;?> fa-fw"></i>
							<!-- <span class="badge">3</span> -->
						</a>
					
						<ul class="dropdown-menu notification">
								<?php
							$sqlmenu2	=$this->db->query("
										SELECT b.role_id, b.gui_id,a.id, a.code,a.name,a.icons, a.caption,b.active, a.parent_id, a.link FROM	tr_gui AS a
						...
						?>
							<li class="dropdown-title">
								<span>
								<i class="fa <?php echo $menu2->icons;?> fa-fw"></i> <?php echo $menu2->caption;?><span>
							</li>

							<?php
							
							$sqlmenu3	=$this->db->query("
									SELECT b.role_id, b.gui_id,a.id,	a.code,	a.name,a.icons, a.caption,b.active, a.parent_id, a.link FROM	tr_gui AS a
...
$warna = array("label-danger","label-primary","label-info","label-success","label-warning","label-default");
						$rand_warna = shuffle($warna);	
							?>

							<li>
								<a href="<?php echo site_url().$menu3->link;?>">
									
									<span class="label <?php echo $warna[$rand_warna]; ?>">
									
									<i class="fa <?php echo $menu3->icons;?> fa-fw"></i>
									</span>
									<span class="body">
										<span class="message"><?php echo $menu3->caption;?> </span>
										<!-- <span class="time">
											<i class="fa fa-clock-o"></i>
											<span>Just now</span>
										</span> -->
