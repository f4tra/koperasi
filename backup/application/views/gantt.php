...
<head>
  ...
  <link rel=stylesheet href="<?php echo base_url();?>assets/gantt/ganttPrint.css" type="text/css" media="print">
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/gantt/libs/jquery.svg.css">
  <script type="text/javascript" src="<?php echo base_url();?>assets/gantt/libs/jquery.svg.min.js"></script>

  <!--In case of jquery 1.7-->
  <!--<script type="text/javascript" src="libs/jquery.svgdom.pack.js"></script>-->

  <!--In case of jquery 1.8-->
  <script type="text/javascript" src="<?php echo base_url();?>assets/gantt/libs/jquery.svgdom.1.8.js"></script>
  ...
  <script src="<?php echo base_url();?>assets/gantt/ganttDrawerSVG.js"></script>
