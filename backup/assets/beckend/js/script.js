var App = function() {
    ...
    l = function() {
        n = $("#sidebar").hasClass("mini-menu"),
        o = $("#header").hasClass("navbar-fixed-top")
    },
    c = function() {
        var e, t = $("#content"),
        i = $("#sidebar"),
        n = $("body");
        e = n.hasClass("sidebar-fixed") ? $(window).height() - $("#header").height() + 1 : i.height() + 20,
        e >= t.height() && t.attr("style", "min-height:" + e + "px !important")
    },
    d = function() {
        jQuery(".sidebar-menu .has-sub > a").click(function() {
            var e = jQuery(".has-sub.open", $(".sidebar-menu"));
            e.removeClass("open"),
            jQuery(".arrow", e).removeClass("open"),
            jQuery(".sub", e).slideUp(200);
            var t = $(this),
            i = -200,
            n = 200,
            o = jQuery(this).next();
            o.is(":visible") ? (jQuery(".arrow", jQuery(this)).removeClass("open"), jQuery(this).parent().removeClass("open"), o.slideUp(n, function() {
                0 == $("#sidebar").hasClass("sidebar-fixed") && App.scrollTo(t, i),
                c()
    ...
    u = function() {
        ...
        jQuery(".sidebar-collapse i").removeClass(i),
        jQuery(".sidebar-collapse i").addClass(n),
    ...
    p = function() {
        ...
        1 === e.parent(".slimScrollDiv").size() && (e.slimScroll({
            destroy: !0
        }), e.removeAttr("style"), $("#sidebar").removeAttr("style")),
        e.slimScroll({
            size: "7px",
            color: "#a1b2bd",
            opacity: .3,
    ...
    f = function() {
        ...
        if (1 === e.parent(".slimScrollDiv").size() && (e.slimScroll({
            destroy: !0
        }), e.removeAttr("style"), $("#sidebar").removeAttr("style")), 0 === $(".sidebar-fixed").size()) return c(),
        void 0;
        var t = r();
        if (t.width >= 992) {
    ...
    v = function() {
        y(),
        $(".project-switcher-btn").click(function(i) {
            i.preventDefault(),
            e(this),
       ...
       /* $("body").click(function(t) {
        ...
        t = function(e) {
            ...
            return "undefined" == typeof t && (t = "#project-switcher"),
            t
        }
    },
    y = function() {
        $(".project-switcher").each(function() {
            ...
            e.css("position", "relative").css("margin-top", "0").hide(),
            $("ul", this).width(t)
        })
    },
    _ = function() {
    ...
    T = function() {
        /*jQuery(document).ready(function() {
            ...
            $("#curr-time").html(e),
            $("#curr-time").attr("title", e),
            $("#curr-time").attr("data-original-title", e),
            $("#yesterday").html(t),
            $("#yesterday").attr("title", t),
            $("#yesterday").attr("data-original-title", t),
    ...
    P = function() {
        function e(e, t) {
            ...
            $(i).offset(tp),
            $(i).find(".tooltip-inner").text(t.value)
        }
        $("#slider").slider({
            value: 15,
            slide: e,
        ...
        $(".knob").knob({
            ...
            draw: function() {
                if ("tron" == this.$.data("skin")) {
                    ...
                    this.o.cursor && (n = o - .3) && (o += .3),
                    this.o.displayPrevious && (e = this.startAngle + this.angle(this.v), this.o.cursor && (i = e - .3) && (e += .3), this.g.beginPath(), this.g.strokeStyle = this.pColor, this.g.arc(this.xy, this.xy, this.radius - this.lineWidth, i, e, !1), this.g.stroke()),
                    this.g.beginPath(),
                    this.g.strokeStyle = a ? this.o.fgColor : this.fgColor,
                    this.g.arc(this.xy, this.xy, this.radius - this.lineWidth, n, o, !1),
                    this.g.stroke(),
                    this.g.lineWidth = 2,
                    this.g.beginPath(),
    ...
    D = function() {
        ...
        $("#nestable-menu").on("click", function(e) {
            var t = $(e.target),
            i = t.data("action");
            "expand-all" === i && $(".dd").nestable("expandAll"),
            "collapse-all" === i && $(".dd").nestable("collapseAll")
        }),
        $("#nestable3").nestable()
    },
    X = function() {
    ...
    G = function() {
        ...
        function t(e, t) {
            var i = "";
            "unsupported-file-type" === e ? i = "Unsupported format " + t : console.log("error uploading file", e, t),
            $('<div class="alert"> <button type="button" class="close" data-dismiss="alert">×</button><strong>File upload error</strong> ' + i + " </div>").prependTo("#alerts")
        }
        e(),
        $("#editor").wysiwyg({
            fileUploadError: t
    ...
    tt = function() {
        $(".sparkline").each(function() {
            var e, t, i, n;
            return i = $(this).attr("data-color") || "red",
            n = "18px",
            $(this).hasClass("big") && (t = "5px", e = "2px", n = "40px"),
            $(this).sparkline("html", {
                type: "bar",
    ...
    it = function() {
        ...
        s = $("#calendar").fullCalendar({
            ...
            {
                title: "inux Long Event",
                start: new Date(2013, o, n - 5),
    ...
    lt = function(e) {
        var t = function() {
            ...
            if (0 != i.length) {
                ...
                o = "";
                o += '<li class="animated fadeInLeft media">',
                o += '<a class="pull-right" href="#">',
                o += '<img class="media-object" alt="Generic placeholder image" src="img/chat/headshot2.jpg">',
                o += "</a>",
                o += '<div class="pull-right media-body chat-pop mod">',
                o += '<h4 class="media-heading">You <span class="pull-left"><abbr id="curr-time" class="timeago" title="' + n + '" >' + n + '</abbr> <i class="fa fa-clock-o"></i></span></h4>',
                o += i,
                o += "</div>",
                o += "</li>";
                var a = $("." + e + " .chat-list");
    ...
    dt = function() {
        ...
        $("#address-book .slider-content ul li ul li a").click(function(e) {
            ...
            $("#contact-card .panel-title").html(i),
            $("#contact-card #card-name").html(i);
			//***** andri
			$("#card-address").html(getAddressByCardName(i));
			$("#card-phone").html(getPhoneByCardName(i));
			$("#card-email").html(getEmailByCardName(i));
			//alert(getAddressByCardName('AKHMAD GOJALI SS'));
			//getAddressByCardName(i)
			//alert(i);
			
			//*****************
            var n = Math.floor(5 * Math.random()) + 1;
            $("#contact-card .headshot img").attr("src", "img/addressbook/" + n + ".jpg"),
            t.removeClass("animated fadeInUp").addClass("animated fadeInUp"),
            window.setTimeout(function() {
    ...
    ht = function() {
        $("#list-toggle .list-group li a").click(function() {
            $("#list-toggle .list-group > li a.active").removeClass("active"),
            $(this).addClass("active")
        })
    },
    mt = function() {
    ...
    ft = function() {
        i && o && $("#main-content").addClass("margin-top-100"),
        !i && o && $("#main-content").removeClass("margin-top-100").addClass("margin-top-52")
    },
    gt = function() {
        function e() {
            function e(e, t, i) {
        ...
        function t() {
            function e(e) {
                ...
                i.setUTCDate(i.getUTCDate() - (i.getUTCDay() + 1) % 7),
                i.setUTCSeconds(0),
                i.setUTCMinutes(0),
                i.setUTCHours(0);
                var n = i.getTime();
            ...
            for (var t = [
                ...
                [12037212e5, 126],
                [12038076e5, 157],
                [1203894e6, 288]], i = 0; i < t.length; ++i) t[i][0] += 36e5;
            var n = {
                series: {
                    lines: {
                        show: !0,
    ...
    vt = function() {
        var e = function(e) {
            $("#skin-switcher").attr("href", "css/themes/" + e + ".css"),
            $.cookie("skin_color", e)
        };
    ...
    return {
        init: function() {
            ...
            App.isPage("widgets_box") && mt(),
            App.isPage("elements") && (x(), E(), A(), M(), T()),
            App.isPage("button_icons") && (S(), j()),
            App.isPage("sliders_progress") && (P(), L(), O()),
            App.isPage("treeview") && H(),
            App.isPage("nestable_lists") && D(),
            App.isPage("simple_table") && X(),
            App.isPage("dynamic_table") && R(),
            App.isPage("jqgrid_plugin") && F(),
            App.isPage("forms") && (U(), q(), N(), W(), Q(), T()),
            App.isPage("rich_text_editors") && G(),
            App.isPage("dropzone_file_upload") && J(),
            App.isPage("xcharts") && Y(),
            App.isPage("others") && (Z(), K(), tt()),
            App.isPage("calendar") && (it(), Q()),
            App.isPage("vector_maps") && nt(),
            App.isPage("gallery") && (ot(), at(), st()),
            App.isPage("login") && Q(),
            App.isPage("wizards_validations") && Q(),
            App.isPage("login_bg") && (Q(), rt()),
            App.isPage("chats") && (lt("chat-window"), lt("chat-widget"), B()),
            App.isPage("todo_timeline") && ct(),
            App.isPage("address_book") && dt(),
            App.isPage("orders") && B(),
            App.isPage("faq") && ut(),
            App.isPage("inbox") && ht(),
            App.isPage("user_profile") && et(),
            App.isPage("mini_sidebar") && u(),
            App.isPage("fixed_header_sidebar") && f(),
            l(),
            d(),
            m(),
            c(),
        ...
        getURLParameter: function(e) {
            ...
            o = n.split("&");
            for (t = 0; t < o.length; t++) if (i = o[t].split("="), i[0] == e) return unescape(i[1]);
            return null
        },
...
function(e) {
    e.fn.admin_tree = function(t) {
        ...
        this.each(function() {
            var t = e(this);
            t.html('<div class = "tree-folder" style="display:none;">				<div class="tree-folder-header">					<i class="' + i["close-icon"] + '"></i>					<div class="tree-folder-name"></div>				</div>				<div class="tree-folder-content"></div>				<div class="tree-loader" style="display:none"></div>			</div>			<div class="tree-item" style="display:none;">				' + (null == i["unselected-icon"] ? "" : '<i class="' + i["unselected-icon"] + '"></i>') + '				<div class="tree-item-name"></div>			</div>'),
            t.addClass(1 == i.selectable ? "tree-selectable" : "tree-unselectable"),
            t.tree(i)
        }),
        this
    }
